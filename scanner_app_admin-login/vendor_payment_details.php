	<?php 
		...
		$e_vendor_code = $_GET["p_vendorcode"];
		if (isset($_GET["p_vendorcode"])){

			// payment details
		$payment_fetch = $conn->prepare("SELECT * FROM vendor_payments_details WHERE sub_status=1  AND  vendor_code=?");
		$payment_fetch->bind_param('s', $e_vendor_code);
		$payment_fetch->execute();
		$payment_fetch_res = $payment_fetch->get_result();
		$row_payment = $payment_fetch_res->fetch_assoc();
		...
		$transaction_fetch = $conn->prepare("SELECT * FROM transactions");
		$transaction_fetch->execute();
		$transaction_fetch_res = $transaction_fetch->get_result();
		$row_transaction = $transaction_fetch_res->fetch_assoc();
		...
		// $chapter_fetch = $conn->prepare("SELECT * FROM vendor_payments_details");
		...
		<div class="col-lg-12">
			...
			<div class="card card-custom gutter-b example example-compact">
				...
				<?php
						...
						//vendor details
						if (isset($_GET["p_vendorcode"])){
					$vendor_fetch = $conn->prepare("SELECT * FROM vendor_registration WHERE vendor_code=?");
					$vendor_fetch->bind_param('s', $e_vendor_code);
					$vendor_fetch->execute();
					$vendor_fetch_res = $vendor_fetch->get_result();
					$row_vendor = $vendor_fetch_res->fetch_assoc();
						}
				?>
				<!--begin::Form-->
				<form class="form">
					<div class="card-body">
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<input value="<?php echo $row_vendor["vendor_full_name"]?>" disabled class="form-control"  placeholder="Enter full name"/>
								
							</div>
							<div class="col-lg-6">
								<label>Contact Number:</label>
								<input value="<?php echo $row_vendor["vendor_phno"]?> " disabled type="email" class="form-control" placeholder="Enter contact number"/>
						...
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<input value="<?php echo $row_vendor["vendor_email"]?> " disabled class="form-control"  placeholder="Enter full name"/>
								
							</div>
							<div class="col-lg-6">
								<label>Vendor Businness Name:</label>
								<input value="<?php echo $row_vendor["vendor_trade_name"]?> " disabled type="email" class="form-control" placeholder="Enter contact number"/>
					...
					<div class="card-body">
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<input value="<?php echo $row_transaction["item_number"]?>" disabled class="form-control"  placeholder="Enter full name"/>
								
							</div>
							<div class="col-lg-6">
								<label>Item price:</label>
								<input value="<?php echo $row_transaction["item_price"]?>" disabled class="form-control" placeholder="Enter contact number"/>
						...
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<input value="<?php echo $row_transaction["paid_amount"];echo'.'; echo $row_transaction["item_price_currency"];?>" disabled class="form-control"  placeholder="Enter full name"/>
								
							</div>
							<div class="col-lg-6">
								<label>Stripe Payment gateway transaction</label>
								<input value="<?php echo $row_transaction["txn_id"]?>" disabled class="form-control" placeholder="Enter contact number"/>
	...
	if (isset($_GET["p_vendorcode"])){
			// grace details
		$grace_fetch = $conn->prepare("SELECT * FROM admin_grace_period WHERE grace_status=1 AND  vendor_code=?");
		$grace_fetch->bind_param('s', $e_vendor_code);
		$grace_fetch->execute();
		$grace_fetch_res = $grace_fetch->get_result();
		$row_grace = $grace_fetch_res->fetch_assoc();
	}
	?>
				...
				<form class="form">
					<div class="card-body">
						<div class="form-group row">
							<div class="col-lg-6">
								<label>Grace Id:</label>
								<input value="<?php echo $row_grace["grace_id"]?>" disabled class="form-control"  placeholder="Enter full name"/>
								
							</div>
							<div class="col-lg-6">
								<label>Grace Amount:</label>
								<input value="<?php echo $row_grace["amount"]; echo'.'; echo $row_transaction["item_price_currency"];?>" disabled class="form-control" placeholder="Enter contact number"/>
						...
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<input value="<?php echo $row_grace["grace_start_date"]?>" disabled class="form-control"  placeholder="Enter full name"/>
								
							</div>
							<div class="col-lg-6">
								<label>Grace End Date:</label>
								<input value="<?php echo $row_grace["grace_end_date"]?>" disabled type="email" class="form-control" placeholder="Enter contact number"/>
