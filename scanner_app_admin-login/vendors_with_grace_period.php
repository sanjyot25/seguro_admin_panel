...
$grace_details_fetch = $conn->prepare("SELECT * FROM admin_grace_period WHERE grace_status=1");
$grace_details_fetch->execute();
$grace_details_fetch_res = $grace_details_fetch->get_result();
$get_orders_row = $grace_details_fetch_res->fetch_assoc();
...
<div class="card card-custom gutter-b">
	<div class="card-header flex-wrap py-3">
		<div class="card-title">
			<h3 class="card-label">
				Vendors with active grace period
