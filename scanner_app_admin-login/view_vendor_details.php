...
// $SQL="SELECT * FROM vendor_registration WHERE vendor_code='".$vendor_code."'";
// console.log(var_dump($SQL));
$chapter_fetch = $conn->prepare("SELECT * FROM vendor_registration WHERE vendor_code = '".$vendor_code."'");
$chapter_fetch->bind_param('s', $vendor_code);
...
<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto"  id="kt_aside">
	...
	</svg><!--end::Svg Icon--></span><span class="menu-text">Change Password</span></a>
				...
				<div class="card-body">
					<div class="form-group row">
						<div class="col-lg-6">
							...
							<input  value="<?php echo $row["vendor_full_name"]?>" class="form-control" placeholder="Enter full name" disabled/>
							
						</div>
						<div class="col-lg-6">
							<label>Contact Number:</label>
							<input value="<?php echo $row["vendor_phno"]?>" class="form-control" placeholder="Enter contact number" disabled/>
					...
					<div class="form-group row">
						<div class="col-lg-6">
							...
							<input  value="<?php echo $row["vendor_email"]?>" class="form-control" placeholder="Enter full name" disabled/>
							
						</div>
						<div class="col-lg-6">
							<label>Vendor trade name:</label>
							<input value="<?php echo $row["vendor_trade_name"]?>" class="form-control" placeholder="Enter contact number" disabled/>
					...
					<div class="form-group row">
						<div class="col-lg-6">
							<label>Vendor Businness Address:</label>
							<input  value="<?php echo $row["vendor_business_address"]?>" class="form-control" placeholder="Enter full name" disabled/>
							
						</div>
						<div class="col-lg-6">
							<label>Vendor Businness name:</label>
							<input  value="<?php echo $row["vendor_business_name"]?>" class="form-control" placeholder="Enter full name" disabled/>
					...
					<div class="form-group row">
						<div class="col-lg-6">
							<label>Vendor Businness Category:</label>
							<input  value="<?php echo $row["vendor_business_category"]?>" class="form-control" placeholder="Enter full name" disabled/>
							
						</div>
						<div class="col-lg-6">
							<label>Vendor code:</label>
							<input  value="<?php echo $row["vendor_code"]?>" class="form-control" placeholder="Enter full name" disabled/>
					...
					<div class="form-group row">
						<div class="col-lg-6">
							<label>Vendor joined On :</label>
							<input  value="<?php echo $row["vendor_created_timestamp"]?>" class="form-control" placeholder="Enter full name" disabled/>
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <circle fill="#000000" opacity="0.3" cx="19.5" cy="17.5" r="2.5"/>
                            ...
                            <span class="navi-text text-muted text-hover-primary"><?php echo $row["vendor_email"]?></span>
                        </span>
                    </a>
